...
class MainWindowSessionMixin(_MainWindowBase):
    ...
    def _setup_menu_bar(self):
        ...
        about_action = about_menu.addAction("About Croissant Control Center")
    ...
    def _save_session(self, file_path: Path):
        ...
        try:
            state = self.session_manager.create_state_dict(
                ...
                croissant=self._croissant_state_dict(),
            )
    ...
    def _load_session(self, file_path: Path):
        ...
        try:
            ...
            self._restore_croissant_state(state)
    ...
    def _on_about(self):
        ...
        QMessageBox.about(
            self,
            "About Croissant Control Center",
            "Croissant Control Center\n\n"
            "A fork of Red Dust Control Center for two independent Croissant stations "
            "on two LilyGO boards (each Pin_A/B on GPIO 25/26).\n\n"
            "Features:\n"
            "- Load and visualize seismic data from PDS archive\n"
            "- Two independent story clocks; seismic playback stays global\n"
            "- OSC and serial output to the Croissant object\n"
