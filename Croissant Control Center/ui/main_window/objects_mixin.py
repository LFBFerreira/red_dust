...
class MainWindowObjectsMixin(_MainWindowBase):
    ...
    def _on_object_added(self, object_id: str):
        ...
        self.osc_manager.apply_croissant_station(object_id, config.get("croissant_station"))
    ...
    def _on_object_config_changed(self, object_id: str):
        ...
        if needs_recreate:
            ...
            self.osc_manager.apply_croissant_station(
                object_id, config.get("croissant_station")
            )
            if was_streaming:
                self.osc_manager.start_object_streaming(object_id)
