...
WIDGET_DEBUG_COLORS: dict[str, str] = {
    ...
    "ObjectCards": "#9b59b6",
    "LogViewer": "#f39c12",
    "StoryTimeline1": "#e67e22",
    "StoryTimeline2": "#d35400",
}
...
def iter_widget_debug_targets(main_window) -> Iterable[tuple[str, QWidget]]:
    ...
    timelines = getattr(main_window, "story_timelines", None) or []
    for i, panel in enumerate(timelines):
        yield f"StoryTimeline{i + 1}", panel
