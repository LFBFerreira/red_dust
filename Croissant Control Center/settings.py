"""
Configuration settings for Croissant Control Center.
...
QSETTINGS_APPLICATION = "Croissant Control Center"
...
STATIONS_PANEL_WIDTH = 720  # Initial width of the Serial / OSC object cards column
...
# --- Croissant story timelines (two independent stations) ---

# Stations: one LilyGO each. Both boards map Pin_A/B (GPIO 25/26).
STATION_COUNT = 2
STATION_TITLES = ("Station 1", "Station 2")
STATION_PIN_LABELS = (
    ("Pin_A", "Pin_B"),
    ("Pin_A", "Pin_B"),
)
# Lanes per station timeline (wire slots 0–1 and 2–3).
STORY_PIN_COUNT = 2
...
# Waveform playback-speed envelope drawn on each station timeline.
STORY_SPEED_MIN = 1.0
